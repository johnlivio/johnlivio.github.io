const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Desenvolvemos o conceito inicial para a homepage, telas de login e cadastro, blog e newsletter, alinhados ao design system e guia gráfico da marca, com o objetivo de oferecer uma experiência visual integrada e consistente aos usuários.',
    },
  ];
          ...
          {projects.map((project) => (
            <div key={project.title} className="group relative">
              <div className="relative overflow-hidden rounded-lg">
                <h3 className="text-xl font-semibold text-[#3E2723] mb-2 pb-2">{project.title}</h3>
                <img
                  src={project.image}
                  alt={project.title}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 ">
                  <div className="absolute top-0 left-0 right-0 p-6">
                    <p className="text-m font-semibold text-[#D7CCC8] mb-2 pt-6">{project.category}</p> 
