const Project1 = () => {
  ...
  return (
    <section id="project1" className="py-20 bg-white items-center">
            ...
            <div className="items-center">
                ...
                <div className="items-center">
                  ...
                  <p className="text-gray-800 mt-8 mb-8 mr-12 ml-12 font-semibold text-center">
                    Realizamos pesquisas com os usuários e stakedholders para avaliar a efetividade dos disparos de mensagens, identificar brechas no sistema e entender os principais problemas causados pelos disparos gerais (para todos os contatos). Essas pesquisas nos forneceu “insights” sobre como aprimorar nossas comunicações, retornos e melhorar a experiência do usuário.
                  </p>
                  <div className="relative flex justify-center p-6">
                    <img
                      src="imagens\diagrama-listas.png?raw=true?auto=format&fit=crop&q=80"
                      alt="Professional workspace"
                ...
                <div className="items-center">
                  ...
                  <div className="relative flex justify-center p-6">
                    <img
                      src="imagens\diagrama-listas2.png?raw=true?auto=format&fit=crop&q=80"
                      alt="Professional workspace"
