    ...
    <section id="project3" className="py-20 bg-white items-center scroll-mt-16">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center bg-gradient-to-b from-gray-50 to-white pt-12">
          <div>
            <h3 className="text-3xl font-bold mb-8 text-center">{i18n.t('titles.concept_viva')}</h3>
...
{i18n.t('text.context_viva_program')}              </p>
            </div>
...
{i18n.t('text.exploration_viva_program')}              </p>
            ...
            {/* Wireframing */}
            <div className="items-center">
              <h2 className="text-3xl font-bold m-2 text-center">{i18n.t('titles.wireframing')}</h2>
              <p className="text-gray-800 mt-8 mb-8 mr-12 ml-12 font-semibold text-center">
{i18n.t('text.wireframing_viva_program')}              </p>
              <div className="relative flex justify-center p-6">
                <img
            ...
            {/* Designs */}
            <div className="items-center">
              <h2 className="text-3xl font-bold m-2 text-center">{i18n.t('titles.designs')}</h2>
              <p className="text-gray-800 mt-8 mb-8 mr-12 ml-12 font-semibold text-center">
{i18n.t('text.designs_viva_program')}              </p>
              <div className="relative flex justify-center p-6">
                <img
